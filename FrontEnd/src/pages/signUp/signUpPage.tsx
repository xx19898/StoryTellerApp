...
const SignUpPage = () => {
    ...
    return(
        <div ref={mainRef} className="w-auto min-h-screen h-auto bg-base font-belanosima flex flex-col justify-center items-center text-white">
            ...
            <input {...register("username",{minLength:4})} ref={usernameInput} className="input col-span-2 col-start-0 bg-white text-black"/>
            <label ref={passwordLabel} className="mx-auto col-span-1 col-start-0">Password</label>
            <input {...register("password",{minLength:8})} ref={passwordInput} type={'password'} className="input col-span-2 bg-white text-black"/>
